...
the Command Interface (`ConnectionType.COMMAND_INTERFACE`) which uses 
the gRPC protocol, , from *outside* a workload — unlike the
...
Install the SDK with the `command` extra from the repository root:
